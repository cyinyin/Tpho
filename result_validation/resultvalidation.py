...
def result_validation():
    ...
    # ================================#
    #  Obtaining  data
    predict_validation_data_tsv = Args().predict_validation_data_tsv
    predict_validation_data_fasta = Args().predict_validation_data_fasta
    all_information = []
    ...
    # 添加表头
    table.field_names = ["uniprot id", "opt", "predict value"]  # experimental value
